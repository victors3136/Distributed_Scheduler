...
## Running the project
```bash
> docker pull victors3136/distributed-transaction-scheduler:latest
> docker-compose up -d
```
Following this, the endpoints from the class ApiController will be available under http://localhost:8080/submit
